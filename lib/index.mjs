...
export function loadIndex() {
  ...
  const rows = new Float32Array(buf.buffer, buf.byteOffset, buf.byteLength / 4);
...
export async function rebuild(notes, embedFn) {
  ...
  for (const n of notes) {
    ...
    meta.push({ id: n.id, path: n.path, created: n.created, origin: n.origin, scope: n.scope, tags: n.tags, gist: n.gist });
  }
